...
public class DepartmentView {
	...
	private void insertDepartment() throws SQLException {
		...
		System.out.print("부서 코드(DEPT_ID) 입력 : ");
		String deptId = sc.next();
		
		System.out.print("부서명(DEPT_TITLE) 입력 : ");
		String deptTitle = sc.next();
		
		System.out.print("부서 코드 (LOCATION_ID) 입력 : ");
	...
	private void selectAll() throws SQLException{
		...
		for(Department dept : deptList) {
			System.out.println(dept); // 자동으로 toString() 호출
		}
	}
	...
	private void selectDepartmentTitle() throws SQLException{
		...
		// -> 검색 결과가 없음
		if(deptList.isEmpty()) {
			System.out.println(title + "이(가) 포함된 부서가 없습니다.");
		}
		else {
			for(Department dept : deptList) {
	...
	private void deleteDepartment() throws SQLException{
		...
		System.out.print("삭제할 부서의 부서 코드 입력 : ");
		String deptId = sc.next();
		
		// 입력 받은 부서 코드와 같은 부서 코드를 가지는 행이 있는지 검사
		// -> 있을 경우 "정말 삭제 하시겠습니까?" 한 번 더 물어보기
	...
	/** 부서 코드 입력 받아 해당 부서명 바꾸기
	 * @throws SQLException
	 */
//	private void changeDepartmentTitle() throws SQLException{
//		System.out.println("\n----- 부서명 변경 -----\n");
//		
//		System.out.print("이름을 변경할 부서의 부서 코드 입력 : ");
//		String deptId = sc.next();
//		
...
//		
//		int result = dao.changeDepartmentTitle(dept);
//		
//		if(result > 0) {
//			System.out.println("\n[변경 성공]\n");
//		}
//		else {
//			System.out.println(deptId + " 부서 코드를 가진 부서가 존재하지 않습니다.");
//		}	
//	}
